...
export default function Page() {
  ...
  return (
    <Box title="Caja Chica" color={bg[clr]}>
      <div style={{ display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", minHeight:"300px", gap:"16px", textAlign:"center" }}>
        ...
        <div>
          <h2 style={{ fontSize:"18px", fontWeight:700, color:"#444", margin:"0 0 8px" }}>Caja Chica</h2>
          <p style={{ fontSize:"13px", color:"#888", maxWidth:"400px", lineHeight:1.6 }}>Control de fondo de caja chica</p>
        </div>
