...
export default function Page() {
  ...
  return (
    <Box title="Eliminar Reenganche" color={bg[clr]}>
      <div style={{ display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", minHeight:"300px", gap:"16px", textAlign:"center" }}>
        ...
        <div>
          <h2 style={{ fontSize:"18px", fontWeight:700, color:"#444", margin:"0 0 8px" }}>Eliminar Reenganche</h2>
          <p style={{ fontSize:"13px", color:"#888", maxWidth:"400px", lineHeight:1.6 }}>Elimina un reenganche registrado</p>
        </div>
        <div style={{ display:"flex", gap:"8px" }}>
          <Btn color="red">Continuar</Btn>
