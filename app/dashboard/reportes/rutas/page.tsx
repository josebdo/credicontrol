...
export default function Page() {
  ...
  return (
    <Box title="Prestamos por Rutas" color={bg[clr]}>
      <div style={{ display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", minHeight:"300px", gap:"16px", textAlign:"center" }}>
        ...
        <div>
          <h2 style={{ fontSize:"18px", fontWeight:700, color:"#444", margin:"0 0 8px" }}>Prestamos por Rutas</h2>
          <p style={{ fontSize:"13px", color:"#888", maxWidth:"400px", lineHeight:1.6 }}>Cartera organizada por ruta de cobro</p>
        </div>
        <div style={{ display:"flex", gap:"8px" }}>
          <Btn color="purple">Continuar</Btn>
